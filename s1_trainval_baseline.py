...
parser.add_argument('--lamda', type=float, default=0.1, metavar='LAM',
                    help='value of lamda')
parser.add_argument('--save_check', action='store_false', default=True,
...
record_dir = 'record/%s/%s/%s' % (args.dataset, args.method, 'baseline')
...
if args.net == 'resnet34':
    ...
    G = torchvision.models.inception_v3(pretrained=True)
    inc = 2048
    G.fc = torch.nn.Identity()
else:
                    ...
                    if args.method == 'MME':
                        torch.save(G.state_dict(),
                                   os.path.join(args.checkpath,
                                                "G_iter_model_{}_{}_{}_"
                                                "to_{}_num_{}.pth.tar".
                                                format(args.method, args.net, args.source,
                                                       args.target, str(args.num))))
